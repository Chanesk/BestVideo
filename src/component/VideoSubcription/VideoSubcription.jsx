...
const VideoSubcription = () => {
    ...
    useEffect(() =>{
        const setSubscribeVideo = async() =>{
            try{
                const reponse= await fetch('https://youtube.googleapis.com/youtube/v3/subscriptions?part=snippet&maxResults=20&mine=true&key=AIzaSyBgDejVRUB1-sRFR8tMY1nm8VZb8jPz_o0&access_token='+data);
